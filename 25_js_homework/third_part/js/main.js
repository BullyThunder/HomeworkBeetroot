/*
      Задание:
        Реализуйте метод showMostFavoritedFruit. Метод должен отображать фрукт, 
        который чаще всего указывали как любимый на основе данных по пользователям из массива users.  
*/
        // названия товаров
        let users = [
            {
